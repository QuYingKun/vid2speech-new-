...
#ret=true/false means if get frame
		ret,frame = cap.read()
		if ret==0:
			break
# to gray
...
#		viddata[vidctr,:,:,:] = temp_frames[COLORS*(int(i-MARGIN)):COLORS*(int(i+MARGIN+1)),:,:]
